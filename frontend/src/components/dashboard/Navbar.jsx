      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <button className="relative p-2 hover:bg-neutral rounded-lg transition-colors">
            <Bell className="icon-md text-neutral" />
            {unreadCount > 0 && (
              <span className="absolute top-0 right-0 icon-md bg-error0 text-white text-xs rounded-full flex items-center justify-center">
                {unreadCount}
              </span>
            )}
          </button>
          ...
          >
            {mobileMenuOpen ? <X className="icon-md text-neutral" /> : <Menu className="icon-md text-neutral" />}
          </button>
        </div>
      </div>
