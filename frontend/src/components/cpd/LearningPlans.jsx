            ...
            <div className="flex gap-2">
              <Dialog open={addGoalDialogOpen} onOpenChange={setAddGoalDialogOpen}>
                <DialogTrigger asChild>
                  <Button size="sm" onClick={handleOpenAddGoalDialog} className="h-8 px-3 text-xs bg-blue-600 hover:bg-blue-700 text-white shadow-sm">
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button onClick={handleSaveGoal} className="w-full h-9 text-sm bg-blue-600 hover:bg-blue-700 text-white shadow-sm">
              ...
              <Card className="border-slate-200/50 bg-white/80 backdrop-blur-sm shadow-sm">
                <CardContent className="py-12 text-center">
                  ...
                  <Dialog open={createPlanDialogOpen} onOpenChange={setCreatePlanDialogOpen}>
                    <DialogTrigger asChild>
                      <Button size="sm" className="h-8 px-3 text-xs bg-blue-600 hover:bg-blue-700 text-white shadow-sm">Create Learning Plan</Button>
                    </DialogTrigger>
                    <DialogContent>
                      <DialogHeader>
